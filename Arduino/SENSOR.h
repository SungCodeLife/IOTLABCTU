...
extern uint16 FlagTsGb;       // Flag Task global
extern uint16 FlagPoSSGb;       // Flag POLL sensor global
extern uint8  MNTimeSS[19];             // manage time of sensor

extern float    Value_Sensor[6];
extern float    Calibration[8];
extern uint16   Analog_Read[16];
...
* @Param:           uint8 IDSensor, uint16 TimeRead_Sensor, uint16 warmup_time, uint8 *Relay_Sensor, uint16 *Analog_Sensor, float *Analog_Get, float *Value_Sensor, float *Calib, uint16 const TimeLine   
* @Return:          void                                                       
*******************************************************************************/
